...
This is a simple weather forecast app built using React. It allows users to search for the current weather and forecast some of the listed cities in the world. 
...
(Note: Used only select Option only instead of Search Option. )

As Instructed, Utilized Tommorrow.io for obtaining weather details for Cities.
